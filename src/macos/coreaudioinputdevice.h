...
class CoreAudioInputDevice : public InputDevice
{
public:
    CoreAudioInputDevice(DeviceInfo&& info);
    CoreAudioInputDevice() = delete;
...
private:
    ...
    DECLARE_PIMPL_EX(CoreAudioInputDevice)
    DECLARE_DEFAULT_MOVE(CoreAudioInputDevice)
};
